     ...
     <div className={classes.accountsWrapper}>
        ...
        <form className={classes.root} noValidate autoComplete="off">
            <div className={classes.inputFieldWrapper}>
                ...
                <TextField id="code"  variant="outlined" margin="dense"/>
            </div>
            <div className={classes.inputFieldWrapper}>
                <label className={classes.label}>Cost Center :</label>
                <TextField id="cost-center" variant="outlined" margin="dense"/>
            ...
            <div className={classes.inputFieldWrapper}>
                ...
                <TextField id="department" variant="outlined" margin="dense"/>
            ...
            <div className={classes.inputFieldWrapper}>
                ...
                <TextField id="report-category" variant="outlined" margin="dense"/>
                <TextField id="report-category" variant="outlined" margin="dense"/>
            ...
            <div className={classes.inputFieldWrapper}>
                ...
                <TextField id="code-consolidated" variant="outlined" margin="dense"/>
                <TextField id="code-consolidated" variant="outlined" margin="dense"/>
                <TextField id="code-consolidated" variant="outlined" margin="dense"/>
                <TextField id="code-consolidated" variant="outlined" margin="dense"/>
