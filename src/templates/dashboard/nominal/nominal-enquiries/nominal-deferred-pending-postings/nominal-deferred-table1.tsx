...
function createData(
  ...
  return { code,costcenter,department,transactiondate,debitvalue,creditvalue,reference,narrative,urn };
}

const rows = [
  createData(2100,'ADM',4,'03/11/2021',0.00,360.00,'pur/nov/c2','PI/CON002',1308),
  createData(2100,'ADM',4,'03/11/2021',0.00,360.00,'pur/nov/c2','PI/CON002',1308),
  createData(2100,'ADM',4,'03/11/2021',0.00,360.00,'pur/nov/c2','PI/CON002',1308),
  createData(2100,'ADM',4,'03/11/2021',0.00,360.00,'pur/nov/c2','PI/CON002',1308),
  createData(2100,'ADM',4,'03/11/2021',0.00,360.00,'pur/nov/c2','PI/CON002',1308),
...
const headCells: HeadCell[] = [
  ...
  { id: 'transactiondate', numeric: true, disablePadding: false, label: 'Transaction Date' },
...
export default function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof Data>('costcenter');
  ...
  const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      const newSelecteds = rows.map((n) => n.costcenter);
          ...
          >
            ...
            <TableBody>
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected(row.costcenter);
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, row.costcenter)}
                      role="checkbox"
