                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow hover tabIndex={-1}>
                      ...
                      <TableCell align='left'>{row.accountDescription}</TableCell>
                      <TableCell align='left'>{row.transactionType}</TableCell>
                      <TableCell align='left'>{row.soddtype}</TableCell>
                      <TableCell align='left'>{row.documentsType}</TableCell>
                      <TableCell align='left'>{row.reference}</TableCell>
                      <TableCell align='left'>{row.secondReference}</TableCell>
                      <TableCell align='left'>{row.firstReference}</TableCell>
                      <TableCell align='left'>{row.frequency}</TableCell>
                      <TableCell align='left'>{row.day}</TableCell>
                      <TableCell align='left'>{row.paymentsMode}</TableCell>
